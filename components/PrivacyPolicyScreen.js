...
export default function PrivacyPolicyScreen({ email, setPrivacyAccepted }) {
    ...
    return (
        <View style={{ paddingTop: insets.top, flex: 1, paddingBottom: "15%", padding: "5%", backgroundColor: "black" }}>
            ...
            {privacyPolicy ? (
                <View style={{ overflow: "hidden", flex: 1, borderRadius: 21, marginVertical: "5%" }}>
                    <WebView
                        originWhitelist={['*']}
                ...
                <View style={styles.errorContainer}>
                    <Text style={styles.errorText}>Nem sikerült betölteni az adatvédelmi nyilatkozatot.</Text>
                </View>
            )}
            {isAlreadyAccepted ? (
